...
namespace XLocker.Migrations
{
    ...
    [Migration("20231216095421_EmailTemplateSeed")]
    partial class EmailTemplateSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("XLocker.Entities.Service", b =>
                {
                    ...
                    b.Property<string>("CourierToken")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("XLocker.Entities.Service", b =>
                {
                    ...
                    b.HasOne("XLocker.Entities.Service", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.HasOne("XLocker.Entities.User", "Courier")
                        .WithMany()
