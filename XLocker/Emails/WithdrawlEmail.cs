...
{
    public static class WithdrawlEmail
    {
        public static string Name = "Withdrawl";
                    ...
                    >
                      ...
                      <tr>
                        <td class=""wrapper"">
                          ...
                          <p><b></b></p>
                          <p>Paquete Retirado con exito</p>
                          <br />
                          <p>Gracias por utilizar nuestro Casillero</p>
                          <table
                            role=""presentation""
                            border=""0""
                            cellpadding=""0""
        ...
        public static string Subject = "Gracias por Utilizar el servicio";
        ...
        public static EmailDefinitionDTO BuildTemplate(Service service, EmailTemplate? dbTemplate)
        {
            ...
            return new EmailDefinitionDTO { Template = template.Replace("{CustomerName}", service.UserName), Subject = subject };
        }
