...
{
    public static class DueServiceEmail
    {
        public static string Name = "DueService";
        ...
        <html lang=""es"">
          <head>
            ...
            <title>Paquete NO DISPONIBLE</title>
                    ...
                    >
                      ...
                      <tr>
                        <td class=""wrapper"">
                          ...
                          <p>Paquete <b>no disponible</b> para retiro</p>
                          <p>Podemos coordinar</p>
                          <table
                            role=""presentation""
                            border=""0""
                            cellpadding=""0""
        ...
        public static string Subject = "Paquete NO DISPONIBLE";
        ...
        public static EmailDefinitionDTO BuildTemplate(Service service, EmailTemplate? dbTemplate)
        {
            ...
            return new EmailDefinitionDTO { Template = template.Replace("{CustomerName}", service.User.Name), Subject = subject };
        }
    }
}
