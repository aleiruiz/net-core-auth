...
{
    public static class UrgentReminderEmail
    {
        public static string Name = "UrgentReminder";
        ...
        <html lang=""es"">
          <head>
            ...
            <title>[Urgente] Retira tu paquete</title>
                    ...
                    >
                      ...
                      <tr>
                        <td class=""wrapper"">
                          ...
                          <p><b>Importante!</b></p>
                          <p>El vencimiento se acerca:</p>
                          <p><b>36 horas depositado</b> lleva tu paquete<br /></p>
                          <table
                            role=""presentation""
                            border=""0""
                            cellpadding=""0""
        ...
        public static string Subject = "[Urgente] Retira tu paquete";

        public static string Note = "{CustomerName} Hace referencia a el nombre del cliente" +
                                    "{CustomerToken} Hace rreferencia a el token de apertura del cliente" +
        ...
        {
            string template, subject = string.Empty;
            ...
            {
                Template = template.Replace("{CustomerName}", service.User.Name)
